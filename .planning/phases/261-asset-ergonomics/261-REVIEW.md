...
### CR-01: SSRF via unvalidated Fontsource woff2 URL
...
### WR-01: `bundle_name` collision space is small for common path patterns
...
### WR-02: Unvalidated `icon_body` inserted into reconstructed SVG
...
### WR-03: 404 response includes a `Content-Type: text/plain` header but no body content
...
### IN-01: Trybuild pass-fixture has no corresponding `fail/` tests
...
### IN-02: `woff2_dest` does not validate `family` or `subset` before use as path components
