...
| 198-401-challenge | handler | 2 | AMCP-06 (SC-2) | T-198 authn | unauthenticated → `401` + `WWW-Authenticate: Bearer resource_metadata="{APP_URL}/.well-known/oauth-protected-resource"` | unit | `cargo test -p app mcp` | ❌ W0 | ⬜ pending |
