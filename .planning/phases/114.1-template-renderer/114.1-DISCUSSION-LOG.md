# Phase 114.1: Ferro Projections [FERRO REPO] - Discussion Log
...
**Notes:** Downstream Phase 66 runtime needs metadata for button labels and input forms. Minimal strings would require a second lookup.
