...
- **D-03:** The workflow accepts a milestone name as a `workflow_dispatch` input. It runs all incomplete phases in that milestone. Roadmap is always at `.planning/ROADMAP.md` by GSD convention.
