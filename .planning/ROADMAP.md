...
- [x] 215-02-PLAN.md — downstream adoption: VisualContext embeds BaseContext + builder.rs migration + 4 ferro-mcp label-site migrations + test-expectation update (CHAN-01, CHAN-02)
