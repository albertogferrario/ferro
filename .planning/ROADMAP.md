...
Plans:
- [ ] 258-01-PLAN.md — ferro-mcp surface: BUILDER_API + RULE_COMPONENTS additive fixes; generation_context register_composition guidance (six D-03 items, drift-guarded) [POS-12]
