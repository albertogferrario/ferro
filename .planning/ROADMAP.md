...
Plans:
- [ ] 127-01-PLAN.md — Foundation helpers: toml_edit dep, bin_detect, secret_keys, structured .env.example parser, rewrite_ferro_version migration
- [ ] 127-02-PLAN.md — Dockerfile template: ENTRYPOINT/CMD token wiring, single build invocation, .dockerignore README whitelist
