...
Plans:
- [ ] 115-01-PLAN.md — Create spec.rs (Spec, Element, builders, SpecError, from_json, validation) + tests/fixtures + round_trip.rs + reject.rs — additive re-exports
- [ ] 115-02-PLAN.md — Delete v1 types (JsonUiView, Component, ComponentNode, PluginProps, view.rs) and rewrite render.rs / resolve.rs / projection/mod.rs / lib.rs for v2
...
|-------|----------------|--------|-----------|
| 115. Spec v2 Data Structures | 0/5 | In progress | - |
