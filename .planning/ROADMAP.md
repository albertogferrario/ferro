...
Plans:
- [ ] 235-01-PLAN.md — BillableKind → Cow<'static, str> + from_string (WR-04 fix-first)
- [ ] 235-02-PLAN.md — ferro-stripe refund::create_for_payment_intent primitive (D-08)
- [ ] 235-03-PLAN.md — lifecycle find_by_payment_intent / find_by_charge_id / attach_payment_intent
- [ ] 235-04-PLAN.md — StripeGateway pi-refund method + PaymentService processed_log + WR-03 guard
