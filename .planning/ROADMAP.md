...
Plans:
- [ ] 160-01-PLAN.md — Rewrite v1-framing doc comments in ferro-json-ui/src/render/* + projection/builder.rs + layout.rs (D-01, D-02, D-03, Pattern-1, Pattern-8)
- [ ] 160-02-PLAN.md — Delete migration_v1_to_v2_templates fn, registration, and integration test in ferro-mcp/src/tools/code_templates.rs (D-04, Pattern-3)
- [ ] 160-03-PLAN.md — Rewrite scan_json_ui_specs to count v2 JSON spec files + add unit tests (D-05, Pattern-2)
- [ ] 160-04-PLAN.md — Rename json_ui_inspect test fixture to neutral names (D-06, Pattern-4)
- [ ] 160-05-PLAN.md — Rewrite ferro-json-ui/README.md Usage block to current v2 API — Phase 161 publish blocker (D-08, Pattern-6)
...
- [ ] 160-10-PLAN.md — Final verification gate: D-10 grep gates + ferro fmt/clippy/test + gestiscilo cross-repo + ferro-code descope (D-09, D-10, D-11)
