...
**Plans:** 7 plans
- [ ] 200-01-PLAN.md — ServiceDef tenant_column/mcp_ability plain-metadata fields (Wave 1; AMCP-10/11)
- [ ] 200-02-PLAN.md — dispatch tenant predicate (bound param, fail-closed) + handle_tools_call forwarding (Wave 1; AMCP-10)
...
- [ ] 200-07-PLAN.md — dogfood scripted MCP client + GO/NO-GO acceptance (Wave 5; AMCP-10/11; SC-4)
**UI hint**: no
...
| 200. Per-Tenant Scoping, Policy Authorization & Dogfood Acceptance | 0/7 | Not started | - |
