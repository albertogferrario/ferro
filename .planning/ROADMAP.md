...
## ✅ v16.3 MCP CRUD Data Surface (Track A) (Phases 239–243 + 243.1) — Shipped 2026-06-24 (0.2.80)

CRUD-01..07 — full details archived in [milestones/v16.3-ROADMAP.md](milestones/v16.3-ROADMAP.md).
...
DS-01..08 — full details archived in [milestones/v16.5-ROADMAP.md](milestones/v16.5-ROADMAP.md).

Delivered: the design system above the token layer — token vocabulary v2 (23→30 slots with defaults; every v1 theme stays valid), canonical `variant`/`tone`/`size` across all 47 components with an interactive-state quality bar, and `Spec.design` + intent-keyed `design::lint` rules surfaced through `ferro design:lint`, a `design_lint` MCP tool, and `docs/src/design-system/`. Enforced at the agent-authoring boundary; no new crate.
