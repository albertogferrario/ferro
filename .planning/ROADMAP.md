...
- [ ] 196-01-PLAN.md — D-05: next_steps cap 10→5 (MAX_NEXT_STEPS const, 4 doc locations, over-cap test) (Wave 1)
- [ ] 196-02-PLAN.md — D-01/SC-1: poisoned-fixture acceptance test (one dangling field, exact-subject + no-other-field assertions) (Wave 2)
