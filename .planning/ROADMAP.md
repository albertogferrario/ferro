...
**Plans:** 5 plans
- [ ] 199-01-PLAN.md — Crate scaffold (ferro-mcp-oauth Wave-2), fail-closed OAuthConfig + sanitized_app_url, oauth_clients migration, flow-test harness, publish.yml/workspace registration (Wave 1; AMCP-07/08/09)
- [ ] 199-02-PLAN.md — Discovery metadata (RFC 8414/9728) + Dynamic Client Registration (RFC 7591) (Wave 2; AMCP-07; SC-1, SC-2)
- [ ] 199-03-PLAN.md — Crypto core: PKCE S256 (constant-time) + HS256 JWT mint/decode (alg-pinned, aud-bound) + validate_bearer 401/403 mapping (Wave 2; AMCP-08/09; SC-4, SC-5)
