...
> **v16.4** Work Distribution (QUEUED — not shipped), **v16.5** JSON-UI Design System
> (COMPLETE — archive pending), **v16.6** POS Component Suite (COMPLETE — archive pending),
> **v18.0** Projection-Native Frontend Substrate (CURRENT). Archived and removed so far:
> v16.3 (2026-08-12). v17.0 requirements are not in this file (tracked inline in ROADMAP).
