...
- [x] **Phase 114.1: Template Renderer** — 1 plan, verified 6/6 criteria
...
### ✅ v11.2 Deploy & Scaffolder Hardening (Shipped 2026-04-14)

**Milestone Goal:** Rewrite deploy scaffolding for zero-hand-edit deployment, add MCP deploy tools, doctor command, module scaffolder, and harden scaffolder from gestiscilo field-test feedback.

| Phase | Plans | Status |
|-------|-------|--------|
| 122. Deploy Scaffold Core Rewrite | 8 | Complete |
| 122.1. Deploy Scaffold UAT Fixes | 4 | Complete |
| 122.2. Deploy Simplification | 9 | Complete |
| 123. Deploy MCP Tools | 5 | Complete |
| 124. Doctor, Introspection & CI Scaffold | 5 | Complete |
| 125. Module Scaffolder & JSON-UI Runtime Split | 2 | Complete |
| 126. Deploy Experience Feedback | 1 | Complete |
| 127. Generated Artifact Polish | 4 | Complete |
| 128. Deploy Preflight | 4 | Complete |
| 129. Publish Workflow Refinement | 3 | Complete |
| 130. Invert Dep Convention | 1 | Complete |
| 131. Scaffolder Multibin, Copydirs & Runtime APT | 3 | Complete |

**Total:** 12 phases, 49 plans
...
**Total: 26 milestones shipped, 256 plans complete.**
